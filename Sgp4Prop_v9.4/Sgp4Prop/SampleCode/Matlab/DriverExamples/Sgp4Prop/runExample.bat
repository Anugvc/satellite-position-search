...
echo matlab -nosplash -noFigureWindows -batch ^"try, Sgp4Prop('./input/rel14.inp', './output/test.out'), catch, exit, end, exit^"
matlab -nosplash -noFigureWindows -batch "try, Sgp4Prop('./input/rel14.inp', './output/test.out'), catch, exit, end, exit"
