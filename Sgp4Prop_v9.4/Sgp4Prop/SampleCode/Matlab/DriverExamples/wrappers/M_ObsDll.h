...
// pos                position XYZ (km) (ECI or EFG) (in-Double[3])
// csvLine            A string to hold the csv observation format (out-Character[512])
void ObsFieldsToCsv(char secClass, int satNum, int senNum, double obsTimeDs50utc, double elOrDec, double azOrRA, double range, double rangeRate, double elRate, double azRate, double rangeAccel, char obsType, int trackInd, int astat, int siteTag, int spadocTag, double* pos, char* csvLine);
...
int SatNumFrObsKey(__int64 obsKey);
...
int SenNumFrObsKey(__int64 obsKey);
...
void ObsGetSelected(double* xa_selob, int order, int* numMatchedObss, __int64* obsKeys);
