...
int AddManeuverVPStr(__int64 satKey, char* vpString);
...
// returns 0 if the impulsive maneuver is added successfully, non-0 if there is an error.
int AddManeuverVPArr(__int64 satKey, double* xa_vp);
