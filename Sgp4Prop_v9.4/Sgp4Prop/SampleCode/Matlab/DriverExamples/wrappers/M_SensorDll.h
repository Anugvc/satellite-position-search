...
int SensorRemove(__int64 senKey);
...
void SensorGetLoaded(int order, __int64* senKeys);
...
int SensorGetLocAll(__int64 senKey, double* astroLat, double* astroLon, double* senPos, char* senDesc, int* orbSatNum, char* secClass);
...
int SensorSetLocAll(__int64 senKey, double astroLat, double astroLon, double* senPos, char* senDesc, int orbSatNum, char secClass);
...
int SensorGetLocField(__int64 senKey, int xf_SenLoc, char* strValue);
...
int SensorSetLocField(__int64 senKey, int xf_SenLoc, char* strValue);
...
int SensorGet1L(__int64 senKey, char* viewType, char* obsType, int* rngUnits, double* maxRngLim, char* boresight1, double* elLim1, double* elLim2, double* azLim1, double* azLim2, double* interval, int* visFlg, int* rngLimFlg, int* maxPPP, double* minRngLim, int* plntryRes, double* rrLim);
...
int SensorSet1L(__int64 senKey, char viewType, char obsType, int rngUnits, double maxRngLim, char boresight1, double elLim1, double elLim2, double azLim1, double azLim2, double interval, int visFlg, int rngLimFlg, int maxPPP, double minRngLim, int plntryRes, double rrLim);
...
int SensorGet2L(__int64 senKey, char* boresight2, double* elLim3, double* elLim4, double* azLim3, double* azLim4, int* earthBckgrnd, double* earthLimb, double* solarXAngle, double* lunarXAngle, double* minIllum, double* twilit);
...
int SensorSet2L(__int64 senKey, char boresight2, double elLim3, double elLim4, double azLim3, double azLim4, int earthBckgrnd, double earthLimb, double solarXAngle, double lunarXAngle, double minIllum, double twilit);
...
int SensorGetLimField(__int64 senKey, int xf_SenLim, char* strValue);
...
int SensorSetLimField(__int64 senKey, int xf_SenLim, char* strValue);
...
int SensorGetBS(__int64 senKey, double* xaf_senbs);
...
int SensorSetBS(__int64 senKey, double* xaf_senbs);
...
int SensorGetBSField(__int64 senKey, int xaf_senbs, char* strValue);
...
int SensorSetBSField(__int64 senKey, int xaf_senbs, char* strValue);
...
int SensorGetLines(__int64 senKey, char* sCard, char* l1Card, char* l2Card);
...
// returns 0 on success, non-0 if there is an error
int SensorGetOrbSatKey(__int64 senKey, __int64* orbSatKey);
...
// returns 0 on success, non-0 if there is an error
int SensorSetOrbSatKey(__int64 senKey, __int64 orbSatKey);
...
// returns 0 if the input file is read successfully, non-0 if there is an error
int SensorLoadAzElTable(__int64 senKey, char* azElTableFile);
...
int SensorAddSegment(__int64 senKey, int segType, double* xa_seg);
...
int SensorGetSegment(__int64 senKey, int segNum, int* segType, double* xa_seg);
...
__int64 SensorGetSenKey(int senNum);
...
void SensorGetSenKeyML(int senNum, __int64* senKey);
...
__int64 SensorAddFrArray(double* xa_sen, char* xs_sen);
...
int SensorDataToArray(__int64 senKey, double* xa_sen, char* xs_sen);
