...
int BatchDCInit(__int64 apAddr);
...
void BatchDCGetCtrlArr(double* xa_dcCtrl);
...
int BatchDCSetCtrlArr(double* xa_dcCtrl);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, non-0 if there is an error
int BatchDCInitSatObsKeys(__int64 satKey, double* xa_dcCtrl, int numObs, __int64* obsKeys, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, non-0 if there is an error
int BatchDCInitSatObsSel(__int64 satKey, double* xa_dcCtrl, double* xa_selob, int* numObs, __int64* obsKeys, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
int BatchDCIterate(__int64 satKey, double* xa_ObsRes, int* xa_rejFlg, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, 1: dc fails, best elset returned, 2: dc fails, no eleset returned
int SpToTleComb(__int64 satKey, double* xa_egpCtrl, char* line1, char* line2, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
// returns 0 if successful, 1: dc fails, best elset returned, 2: dc fails, no eleset returned
int SpToCsv(__int64 satKey, double* xa_egpCtrl, char* csvLine);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, 1: dc fails, best elset returned, 2: dc fails, no eleset returned
int SpToCsvComb(__int64 satKey, double* xa_egpCtrl, char* csvLine, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, 1: dc fails, best elset returned, 2: dc fails, no eleset returned
int ExtEphemToEGP(char* extEphFile, double* xa_egpCtrl, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
...
// xas_dcElts         String containing resulting BatchDC data, see XAS_DCELTS_? for substring arrangement (out-Character[512])
// returns 0 if successful, 1: dc fails, best elset returned, 2: dc fails, no eleset returned
int IomodDC(int numObs, __int64* obsKeys, double* xa_iomdc, int* xai_dcElts, double* xar_dcElts, char* xas_dcElts);
