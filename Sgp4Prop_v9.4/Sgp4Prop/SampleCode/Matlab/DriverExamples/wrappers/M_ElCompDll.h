...
// elcom_astat        =1:FULL, =2:CLOSE, =3:MAYBE, =4:NONE (out-Integer)
// returns 0 if ElComp is successful, non-0 if there is an error
int ElCompGetResults_MT(double* xa_ecdiff, __int64 priSatKey, __int64 secSatKey, int checkDeltaTime, double* xa_elcom_pri, double* xa_elcom_sec, double* xa_elcom_deltas, int* elcom_astat);
...
// xa_elcom_deltas    delta quantities between primary and secondary satellites.  see XA_ELCOM_? (out-Double[16])
// elcom_astat        =1:FULL, =2:CLOSE, =3:MAYBE, =4:not assoc (out-Integer)
void ElCompFrElData_MT(double* xa_ecdiff, int checkDeltaTime, double* xa_elcom_pri, double* xa_elcom_sec, double* xa_elcom_deltas, int* elcom_astat);
...
// coco_astat         =1:SAME, =2:CLOSE, =5:not assoc (out-Integer)
// returns 0 if Coco is successful, non-0 if there is an error
int CocoGetResults_MT(double* xa_ecdiff, __int64 priSatKey, __int64 secSatKey, double* xa_satData_pri, double* xa_satData_sec, double* xa_coco, int* coco_astat);
...
// xa_coco            delta quantities between pri/sec satellites, see XA_COCO_? for array arrangement (out-Double[16])
// coco_astat         resulting astat value; 1=SAME, 2=CLOSE, 3=NEARBY, 5=NONE (out-Integer)
void CocoFrElData_MT(double* xa_ecdiff, double* xa_satData_pri, double* xa_satData_sec, double* xa_coco, int* coco_astat);
