...
void RotasGetAssocMultipliers(int* xa_assocMultp);
...
void RotasSetAssocMultipliers(int* xa_assocMultp);
...
// satKey             The satellite's unique key (in-Long)
// returns 0 if the observation/satellite pair doesn't have an association, 1 if the pair has an association
int RotasHasASTAT_MT(double* xa_rt_parms, __int64 obsKey, __int64 satKey);
...
// satKey             The satellite's unique key (in-Long)
// returns 0 if the observation/satellite pair doesn't have an association, 1 if the pair has an association
int RotasHasASTATMultp_MT(int* xa_assocMultp, double* xa_rt_parms, __int64 obsKey, __int64 satKey);
...
// obElts             observation state in ECI/TEME of Date: position (1st-3rd), velocity (4th-6th); observation LLH (7th-9th) (out-Double[9])
// returns 0 if successful, non-0 if there is an error
int RotasComputeObsResiduals_MT(double* xa_rt_parms, __int64 obsKey, __int64 satKey, double* xa_ObsRes, double* satElts, double* obElts);
...
// obElts             observation state in ECI/TEME of Date: position (1st-3rd), velocity (4th-6th); observation LLH (7th-9th) (out-Double[9])
// returns 0 if successful, non-0 if there is an error
int RotasComputeObsResidualsMultp_MT(int* xa_assocMultp, double* xa_rt_parms, __int64 obsKey, __int64 satKey, double* xa_ObsRes, double* satElts, double* obElts);
...
// obElts             observation state in ECI/TEME of Date: position (1st-3rd), velocity (4th-6th); observation LLH (8th-9th) (out-Double[9])
// returns 0 if successful, non-0 if there is an error
int RotasComputeTrackResiduals_MT(int* xa_assocMultp, double* xa_rt_parms, __int64* obsKeys, int trackStartIdx, int trackLength, __int64 satKey, double* xa_ObsRes, __int64* trackObsKeys, char* b3ObsCard, double* satElts, double* obElts);
