...
void AofGetDataFrInputFiles(double* xa_aofCtrl, int* numOfInpSats, int* aofInpSats, int* numOfMissions, double* xa_aofSen, int* numOfAreas, double* xa_aofArea);
...
int AofBasic(double* xa_aofRun, __int64 satKey, double* xa_aofSen, double* xa_aofArea, int* numOfPasses, double* xa_entExitTimes);
...
// xa_entExitTimes    array of entry/exit times (out-Double[*])
// returns 0 if successfully, non-0 if there is an error
int AofComplex(double* xa_aofRun, __int64 satKey, double* xa_aofSen, int numOfLlhPts, double* llhArr, int* numOfPasses, double* xa_entExitTimes);
...
int AofGetDarknessLevel(double ds50TAI, double* xa_aofArea);
