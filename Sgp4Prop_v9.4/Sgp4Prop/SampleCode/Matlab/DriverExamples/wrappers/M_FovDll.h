...
int FovFindTargetPasses(double startTimeDs50UTC, double stopTimeDs50UTC, __int64 srcSenKey, __int64 tgtSatKey, double* tgtPassesArr, int* numOfPasses);
