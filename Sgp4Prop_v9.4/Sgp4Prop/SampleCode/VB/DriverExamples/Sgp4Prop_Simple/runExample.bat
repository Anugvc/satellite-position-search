...
REM
REM Simplest solution to get a VB executable to work is to put all dependency DLLs and
...
REM Copy all Astor.NetAssemblies DLLs to the bin folder
copy /Y ..\..\Astro.NetAssemblies\Lib\*.dll .\bin

REM compile all source code
echo Compiling %name%....
devenv.com %name%.vbproj /rebuild "Release|x64"
if %ERRORLEVEL% NEQ 0 (
