...
void EnvGetInfo(char infoStr[128]);
...
int EnvLoadFile(char envFile[512]);
...
int EnvSaveFile(char envConstFile[512], int saveMode, int saveForm);
...
// <tr><td>GEM9</td></tr>
// </table>
void EnvGetGeoStr(char geoStr[6]);
...
// <br>
// The GEO model must be set to WGS-72 to use the SGP4 propagator.
void EnvSetGeoStr(char geoStr[6]);
...
#define XF_GEOCON_FF     1
// J2 (unitless)
#define XF_GEOCON_J2     2
// J3 (unitless)
#define XF_GEOCON_J3     3
// J4 (unitless)
#define XF_GEOCON_J4     4
// Ke (er**1.5/min)
#define XF_GEOCON_KE     5
// Earth radius (km/er)
#define XF_GEOCON_KMPER  6
// Earth rotation rate w.r.t. fixed equinox (rad/min)
#define XF_GEOCON_RPTIM  7

// J2/2 (unitless)
#define XF_GEOCON_CK2    8
// -3/8 J4 (unitless)
#define XF_GEOCON_CK4    9
// Converts km/sec to er/kem
#define XF_GEOCON_KS2EK  10
// Earth rotation rate w.r.t. fixed equinox (rad/kemin)
#define XF_GEOCON_THDOT  11
// J5 (unitless)
#define XF_GEOCON_J5     12
// Gravitational parameter km^3/(solar s)^2
#define XF_GEOCON_MU     13


// Indexes of FK Constant fields
// Earth rotation rate w.r.t. moving equinox (rad/day)
#define XF_FKCON_C1      1
// Earth rotation acceleration(rad/day**2)
#define XF_FKCON_C1DOT   2
// Greenwich angle (1970; rad)
#define XF_FKCON_THGR70  3

// Indexes represent geopotential models GEO
// Earth constants - JGM2
#define XF_GEOMOD_JGM2       2
// Earth constants - GEM5
#define XF_GEOMOD_GEM5       5
// Earth constants - EGM-08
#define XF_GEOMOD_EGM08      8
// Earth constants - GEM9
#define XF_GEOMOD_GEM9       9
// Earth constants - STEM68
#define XF_GEOMOD_STEM68    68
// Earth constants - WGS-72
#define XF_GEOMOD_WGS72     72
// Earth constants - WGS-84
#define XF_GEOMOD_WGS84     84
// Earth constants - EGM-96
#define XF_GEOMOD_EGM96     96
// Invalid earth model
#define XF_GEOMOD_UNKNOWN  100
