...
function freeEnvConst()   
   ...
   clear XF_GEOCON_KE;
   % Earth radius (km/er)
   clear XF_GEOCON_KMPER;
   % Earth rotation rate w.r.t. fixed equinox (rad/min)
   clear XF_GEOCON_RPTIM;
   ...
   clear XF_GEOCON_CK4;
   % Converts km/sec to er/kem
   clear XF_GEOCON_KS2EK;
   % Earth rotation rate w.r.t. fixed equinox (rad/kemin)
   clear XF_GEOCON_THDOT;
   % J5 (unitless)
   clear XF_GEOCON_J5;
   % Gravitational parameter km^3/(solar s)^2
   clear XF_GEOCON_MU;
   ...
   clear XF_FKCON_C1;
   % Earth rotation acceleration(rad/day**2)
   clear XF_FKCON_C1DOT;
   % Greenwich angle (1970; rad)
   clear XF_FKCON_THGR70;
   
   % Indexes represent geopotential models GEO
   % Earth constants - JGM2
   clear XF_GEOMOD_JGM2;
   % Earth constants - GEM5
   clear XF_GEOMOD_GEM5;
   % Earth constants - EGM-08
   clear XF_GEOMOD_EGM08;
   % Earth constants - GEM9
   clear XF_GEOMOD_GEM9;
   % Earth constants - STEM68
   clear XF_GEOMOD_STEM68;
   % Earth constants - WGS-72
   clear XF_GEOMOD_WGS72;
   % Earth constants - WGS-84
   clear XF_GEOMOD_WGS84;
   % Earth constants - EGM-96
   clear XF_GEOMOD_EGM96;
   % Invalid earth model
   clear XF_GEOMOD_UNKNOWN;
   ...
   FreeEnvConstDll;
   clear LoadEnvConstDll;
   clear FreeEnvConstDll;
