...
function loadLamod(OctFilePath)   
   ...
   autoload("LoadLamodDll",strcat(OctFilePath,"Lamod.oct"));
   autoload("FreeLamodDll",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodInit",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetInfo",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodLoadFile",strcat(OctFilePath,"Lamod.oct"));
   
   %  Loads Lamod control parameters and all Lamod related data (environment, time, elsets, sensors) from an input text file
   autoload("LamodLoadFileAll",strcat(OctFilePath,"Lamod.oct"));
   
   %  Loads a single Lamod-typed card
   autoload("LamodLoadCard",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodSaveFile",strcat(OctFilePath,"Lamod.oct"));
   
   %  Returns number of sensors/satellites entered via 1P/2P cards
   %  See LamodGetSenNums for example.
   autoload("LamodGetNumOfSensSats",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetSenNums",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  See LamodGetSenNums for example.
   autoload("LamodGetSatNums",strcat(OctFilePath,"Lamod.oct"));
   
   %  Builds and returns the Lamod parameter card (1P-Card) from the current Lamod settings
   autoload("LamodGet1pCard",strcat(OctFilePath,"Lamod.oct"));
   
   %  Retrieves all Lamod control parameters with a single function call
   autoload("LamodGet1pAll",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  </ul>
   autoload("LamodSet1pAll",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  </table>	
   autoload("LamodGet1pField",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodSet1pField",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGet3pAll",strcat(OctFilePath,"Lamod.oct"));
   
   %  Sets concurrent viewing options similar to what is entered in the input 3P Parameter card
   %  The concurrent viewing implementation is used to be totally in the LamodDll.dll. Now, the Lamod library provides the users the capability to implement the concurrent viewing from their driver programs. There is no limit on the number of satellites/sensors being use in concurrent viewing in the new library.
   autoload("LamodSet3pAll",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetObsFileName",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodSetObsFileName",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodSenSatVisible",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodInitSenSat",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  
   %  Internally, this function does the initial visibility check to see if the sensor can possibly acquire the satellite. However, if the satellite is an EXTEPHEM (see External Ephemerides document), it will always pass this visibility check (assume the satellite is viewable to the sensor).
   autoload("LamodInitSenSat_MT",strcat(OctFilePath,"Lamod.oct"));
   
   %  Retrieves all of the data for an initialized sensor/satellite pair with a single function call
   autoload("LamodGetSenSatDataAll",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  </table>
   autoload("LamodGetSenSatDataField",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodSenSatDataToArray",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetNumPasses",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetRiseCulmSetTimes",strcat(OctFilePath,"Lamod.oct"));
   
   %  Computes a single look angle of the sensor/satellite pair at the specified time
   autoload("LamodComputeLookAngle",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodComputeLookView",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodFindExactIOTime",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGetOrbSenViewdata",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  </table>	
   autoload("LamodGetViewDataField",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodCompRaDec",strcat(OctFilePath,"Lamod.oct"));
   ...
   autoload("LamodGenObs",strcat(OctFilePath,"Lamod.oct"));
   ...
   %  <br>
   autoload("LamodSenSatDirect_OS",strcat(OctFilePath,"Lamod.oct"));
   LoadLamodDll;
endfunction
