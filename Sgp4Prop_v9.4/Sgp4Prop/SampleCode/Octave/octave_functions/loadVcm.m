...
function loadVcm(OctFilePath)   
   ...
   autoload("LoadVcmDll",strcat(OctFilePath,"Vcm.oct"));
   autoload("FreeVcmDll",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmInit",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmGetInfo",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmLoadFile",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmSaveFile",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmRemoveSat",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmRemoveAllSats",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmGetCount",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmGetLoaded",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmAddSatFrLines",strcat(OctFilePath,"Vcm.oct"));
   
   %  Works like VcmAddSatFrLines but designed for Matlab
   autoload("VcmAddSatFrLinesML",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmAddSatFrFields",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmAddSatFrFieldsML",strcat(OctFilePath,"Vcm.oct"));
   
   %  Retrieves VCM data associated with the input satKey
   autoload("VcmRetrieveAllData",strcat(OctFilePath,"Vcm.oct"));
   
   %  Updates a VCM using its individual field values. Note: satellite's number and epoch won't be updated
   %  <br>
   %  See VcmAddSatFrFields for definitions of the xs_vcm and xa_vcm parameters.
   autoload("VcmUpdateSatFrFields",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmGetSatKey",strcat(OctFilePath,"Vcm.oct"));
   
   %  Works like VcmGetSatKey but designed for Matlab
   autoload("VcmGetSatKeyML",strcat(OctFilePath,"Vcm.oct"));
   ...
   autoload("VcmStringToArray",strcat(OctFilePath,"Vcm.oct"));
   LoadVcmDll;
endfunction
