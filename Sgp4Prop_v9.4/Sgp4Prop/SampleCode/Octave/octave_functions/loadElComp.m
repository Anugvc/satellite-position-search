...
function loadElComp(OctFilePath)   
   ...
   autoload("LoadElCompDll",strcat(OctFilePath,"ElComp.oct"));
   autoload("FreeElCompDll",strcat(OctFilePath,"ElComp.oct"));
   
   %  Notes: This function has been deprecated since v9.0. 
   %  Initializes ElComp dll for use in the program 
   autoload("ElCompInit",strcat(OctFilePath,"ElComp.oct"));
   
   %  Returns information about the current version of ElComp.dll. The information is placed in the
   %  string parameter passed-in
   autoload("ElCompGetInfo",strcat(OctFilePath,"ElComp.oct"));
   ...
   autoload("ElCompSetCriteria",strcat(OctFilePath,"ElComp.oct"));
   ...
   %  </table>      
   autoload("ElCompGetCriteria",strcat(OctFilePath,"ElComp.oct"));
   ...
   %  </table>   
   autoload("ElCompGetResults",strcat(OctFilePath,"ElComp.oct"));
   
   %  This is a thread-safe version of the ElCompGetResults
   autoload("ElCompGetResults_MT",strcat(OctFilePath,"ElComp.oct"));
   ...
   autoload("ElCompFrElData",strcat(OctFilePath,"ElComp.oct"));
   
   %  This is a threa-safe version of ElCompFrElData
   autoload("ElCompFrElData_MT",strcat(OctFilePath,"ElComp.oct"));
   
   %  Resets criteria to default values for ElComp 
   autoload("ElCompResetCriteria",strcat(OctFilePath,"ElComp.oct"));
   
   %  Sets up criteria for Coco 
   %  See CocoGetCriteria for a description of the input and output values.
   autoload("CocoSetCriteria",strcat(OctFilePath,"ElComp.oct"));
   ...
   %  <tr><td>18-31 </td><td> unused at this time</td></tr>
   %  </table>   
   autoload("CocoGetCriteria",strcat(OctFilePath,"ElComp.oct"));
   ...
   autoload("CocoGetResults",strcat(OctFilePath,"ElComp.oct"));
   
   %  This is a thread-safe version of CocoGetResults
   autoload("CocoGetResults_MT",strcat(OctFilePath,"ElComp.oct"));
   ...
   autoload("CocoGetResultsWOA",strcat(OctFilePath,"ElComp.oct"));
   
   %  Returns comparison results between two elsets without loading the elsets into TLE dll
   autoload("CocoFrElData",strcat(OctFilePath,"ElComp.oct"));
   
   %  This is a thread-safe version of CocoFrElData
   autoload("CocoFrElData_MT",strcat(OctFilePath,"ElComp.oct"));
   ...
   autoload("CocoFrElDataWOA",strcat(OctFilePath,"ElComp.oct"));
   
   %  Resets criteria to default values for Coco 
   autoload("CocoResetCriteria",strcat(OctFilePath,"ElComp.oct"));
   LoadElCompDll;
endfunction
