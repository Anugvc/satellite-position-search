...
{
   public static partial class ElCompWrapper
   {
      // Provide the path to the dll
      const string ElCompDll = "elcomp";

      // static constructor
      static ElCompWrapper()
      {
      ...
      /// <returns>0 if the ElComp dll is initialized successfully, non-0 if error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int ElCompInit(long apAddr);
      ...
      /// </summary>
      /// <param name="infoStr">A string to hold the information about ElComp.dll (out-Character[128])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompGetInfo(byte[] infoStr);
      ...
      /// </summary>
      /// <param name="xa_ecdiff">Array to store manual setting criteria for "FULL" (MAX1 parameters only).  See XA_ECDIFF_? (in-Double[32])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompSetCriteria(double[] xa_ecdiff);
      ...
      ///       
      /// </summary>
      /// <param name="xa_ecdiff">Array to receive the ElComp criteria.  See XA_ECDIFF_? (out-Double[32])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompGetCriteria(double[] xa_ecdiff);
      ...
      /// <param name="checkDeltaTime">Suppress=0/Allow=1: check on nodal time and sync long (in-Integer)</param>
      /// <param name="xa_elcom_pri">primary satellite data.   see XA_ELCOM_? (out-Double[16])</param>
      /// <param name="xa_elcom_sec">secondary satellite data.   see XA_ELCOM_? (out-Double[16])</param>
      /// <param name="xa_elcom_deltas">delta quantities between primary and secondary satellites.  see XA_ELCOM_? (out-Double[16])</param>
      /// <param name="elcom_astat">=1:FULL, =2:CLOSE, =3:MAYBE, =4:NONE (out-Integer)</param>
      /// <returns>0 if ElComp is successful, non-0 if there is an error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int ElCompGetResults(long priSatKey, long secSatKey, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, out int elcom_astat);
      ...
      /// <returns>0 if ElComp is successful, non-0 if there is an error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int ElCompGetResults_MT(double[] xa_ecdiff, long priSatKey, long secSatKey, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, out int elcom_astat);
      ...
      /// </summary>
      /// <param name="checkDeltaTime">Supress=0/Allow=1: check on nodal time and sync long (in-Integer)</param>
      /// <param name="xa_elcom_pri">primary satellite data   : 0:incli, 1:node, 2:E, 3:omega, 4: mean anomaly, 5:mean motion, 6:epoch.  see XA_ELCOM_? (in-Double[16])</param>
      /// <param name="xa_elcom_sec">secondary satellite data : 0:incli, 1:node, 2:E, 3:omega, 4: mean anomaly, 5:mean motion, 6:epoch.  see XA_ELCOM_? (in-Double[16])</param>
      /// <param name="xa_elcom_deltas">delta quantities between primary and secondary satellites.  see XA_ELCOM_? (out-Double[16])</param>
      /// <param name="elcom_astat">=1:FULL, =2:CLOSE, =3:MAYBE, =4:not assoc (out-Integer)</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompFrElData(int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, out int elcom_astat);
      ...
      /// <param name="elcom_astat">=1:FULL, =2:CLOSE, =3:MAYBE, =4:not assoc (out-Integer)</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompFrElData_MT(double[] xa_ecdiff, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, out int elcom_astat);
      ...
      /// </summary>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void ElCompResetCriteria();
      ...
      /// </summary>
      /// <param name="xa_ecdiff">Array to set the Coco criteria.  see XA_ECDIFF_? (in-Double[32])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoSetCriteria(double[] xa_ecdiff);
      ...
      ///    
      /// </summary>
      /// <param name="xa_ecdiff">Array to receive the Coco criteria.  see XA_ECDIFF_? (out-Double[32])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoGetCriteria(double[] xa_ecdiff);
      ...
      /// <param name="priSatKey">The primary satellite's unique key (in-Long)</param>
      /// <param name="secSatKey">The secondary satellite's unique key (in-Long)</param>
      /// <param name="xa_satData_pri">primary satellite data (see order below).  see XA_SATDATA_? (out-Double[16])</param>
      /// <param name="xa_satData_sec">secondary satellite data (see order below).  see XA_SATDATA_? (out-Double[16])</param>
      /// <param name="xa_coco">primary v.secondary delta quantities (see below).  see XA_COCO_? (out-Double[16])</param>
      /// <param name="coco_astat">=1:SAME, =2:CLOSE, =5:not assoc (out-Integer)</param>
      /// <returns>0 if Coco is successful, non-0 if there is an error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int CocoGetResults(long priSatKey, long secSatKey, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, out int coco_astat);
      ...
      /// <returns>0 if Coco is successful, non-0 if there is an error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int CocoGetResults_MT(double[] xa_ecdiff, long priSatKey, long secSatKey, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, out int coco_astat);
      ...
      /// <returns>0 if Coco is successful, non-0 if there is an error</returns>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern int CocoGetResultsWOA(long priSatKey, long secSatKey, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco);


      /// <summary>
      /// Returns comparison results between two elsets without loading the elsets into TLE dll
      /// </summary>
      /// <param name="xa_satData_pri">primary sat data, see XA_SATDATA_? for array arrangement (in-Double[16])</param>
      /// <param name="xa_satData_sec">secondary sat data.  see XA_SATDATA_? (in-Double[16])</param>
      /// <param name="xa_coco">delta quantities between pri/sec satellites, see XA_COCO_? for array arrangement (out-Double[16])</param>
      /// <param name="coco_astat">resulting astat value; 1=SAME, 2=CLOSE, 3=NEARBY, 5=NONE (out-Integer)</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoFrElData(double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, out int coco_astat);
      ...
      /// <param name="coco_astat">resulting astat value; 1=SAME, 2=CLOSE, 3=NEARBY, 5=NONE (out-Integer)</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoFrElData_MT(double[] xa_ecdiff, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, out int coco_astat);
      ...
      /// </summary>
      /// <param name="xa_satData_pri">primary sat data, see XA_SATDATA_? for array arrangement (in-Double[16])</param>
      /// <param name="xa_satData_sec">secondary sat data, see XA_SATDATA_? for array arrangement (in-Double[16])</param>
      /// <param name="xa_coco">delta quantities between pri/sec satellites, see XA_COCO_? for array arrangement (out-Double[16])</param>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoFrElDataWOA(double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco);
      ...
      /// </summary>
      [DllImport(ElCompDll, CallingConvention = CallingConvention.Cdecl)]
      public static extern void CocoResetCriteria();
