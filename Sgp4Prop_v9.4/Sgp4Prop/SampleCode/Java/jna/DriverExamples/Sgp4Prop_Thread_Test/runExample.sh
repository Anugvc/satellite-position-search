...
"$JAVA_HOME/bin/java" -cp "./:classes:../../lib/*" PropagatorThreadTester1
...
"$JAVA_HOME/bin/java" -cp "./:classes:../../lib/*" PropagatorThreadTester2
...
"$JAVA_HOME/bin/java" -cp "./:classes:../../lib/*" PropagatorThreadTester3
...
"$JAVA_HOME/bin/java" -cp "./:classes:../../lib/*" PropagatorThreadTester4
