 ...
 * the JnaDllMain.SetElsetKeyMode( JnaDllMain.ELSET_KEYMODE_DMA ) to allow duplicate
 * satkeys.  Each thread uses a unique satkey.
 */
public class PropagatorThreadTester4 implements Runnable {
    ...
    public PropagatorThreadTester4(String filename) {
    ...
    public void run() {
        ...
        long satKey = JnaTle.TleAddSatFrLines( line1, line2 );
...
//            }
    ...
    public static void main(String[] args) throws BrokenBarrierException, InterruptedException {
        ...
        List<PropagatorThreadTester4> testers = new ArrayList<>();
        for( int ii=0; ii<nThreads; ii++ ) {
            PropagatorThreadTester4 tester = new PropagatorThreadTester4("File-" + ii + ".txt");
            testers.add(tester);
