...
/** This class defines the JNA component of the wrapper for: Saas */
public class JnaSaas
{
   ...
   */
   public static native void ComputeLnchOrbPlane(double[] xa_lnch, DoubleByReference incli, DoubleByReference node);
