...
/** This class defines the JNA component of the wrapper for: SatState */
public class JnaSatState
{
   ...
   */
   public static native int SatStateGetSatDataAll(long satKey, IntByReference satNum, byte[] satName, IntByReference eltType, IntByReference revNum, DoubleByReference epochDs50UTC, DoubleByReference bField, IntByReference elsetNum, DoubleByReference incli, DoubleByReference node, DoubleByReference eccen, DoubleByReference omega, DoubleByReference mnAnomaly, DoubleByReference mnMotion, DoubleByReference period, DoubleByReference perigeeHt, DoubleByReference apogeeHt, DoubleByReference perigee, DoubleByReference apogee, DoubleByReference a);
   ...
   */
   public static native int SatStateMse(long satKey, double mse, DoubleByReference ds50UTC, IntByReference revNum, double[] pos, double[] vel, double[] llh);
   ...
   * @return 0 if the satellite is propagated/interpolated successfully, non-0 if there is an error
   */
   public static native int SatStateDs50UTC(long satKey, double ds50UTC, DoubleByReference mse, IntByReference revNum, double[] pos, double[] vel, double[] llh);
   ...
   * @param covUVW             6x6 (in 1D array) UVW covariance matrix (out-Double[36])
   ...
   */
   public static native void GetGobsParams(long satKey, double ds50UTC, double[] xa_gobs, IntByReference errCode);
