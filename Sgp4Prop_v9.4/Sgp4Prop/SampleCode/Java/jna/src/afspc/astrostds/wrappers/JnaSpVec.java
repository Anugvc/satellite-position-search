...
/** This class defines the JNA component of the wrapper for: SpVec */
public class JnaSpVec
{
   ...
   */
   public static native void SpVecAddSatFrLinesML(String line1, String line2, LongByReference satKey);
   ...
   * @param satKey             The satKey of the newly added SpVec on success, a negative value on error (out-Long)
   */
   public static native void SpVecAddSatFrFieldsML(double[] pos, double[] vel, char secClass, int satNum, String satName, String epochDtg, int revNum, int elsetNum, double bterm, double agom, double ogParm, String coordSys, LongByReference satKey);
   ...
   * @return 0 if the SpVec is successfully retrieved, non-0 if there is an error
   */
   public static native int SpVecGetAllFields(long satKey, double[] pos, double[] vel, ByteByReference secClass, IntByReference satNum, byte[] satName, byte[] epochDtg, IntByReference revNum, IntByReference elsetNum, DoubleByReference bterm, DoubleByReference agom, DoubleByReference ogParm, byte[] coordSys);
   ...
   */
   public static native int SpVecParse(String line1, String line2, double[] pos, double[] vel, ByteByReference secClass, IntByReference satNum, byte[] satName, byte[] epochDtg, IntByReference revNum, IntByReference elsetNum, DoubleByReference bterm, DoubleByReference agom, DoubleByReference ogParm, byte[] coordSys);
   ...
   */
   public static native void SpVecGetSatKeyML(int satNum, LongByReference satKey);
   ...
   */
   public static native void SpVecFieldsToSatKeyML(int satNum, String epochDtg, LongByReference satKey);
   ...
   * @param satKey             The satKey of the newly added SPVEC on success, a negative value on error. (out-Long)
   */
   public static native void SpVecAddSatFrArrayML(double[] xa_spVec, String xs_spVec, LongByReference satKey);
