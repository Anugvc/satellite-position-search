...
/** This class defines the JNA component of the wrapper for: SpProp */
public class JnaSpProp
{
   ...
   */
   public static native void SpGetApCtrlAll(byte[] geoDir, IntByReference bufSize, IntByReference runMode, IntByReference savePartials, IntByReference isSpectr, DoubleByReference consider, IntByReference decayAlt, IntByReference outCoord);
   ...
   */
   public static native void SpGetPredCtrl(IntByReference startFrEpoch, IntByReference stopFrEpoch, DoubleByReference startTime, DoubleByReference stopTime, DoubleByReference interval);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int SpGetSatDataAll(long satKey, IntByReference satNum, DoubleByReference epochDs50UTC, DoubleByReference epochDs50TAI, DoubleByReference mu, IntByReference hasCovMtx, IntByReference integMode, IntByReference nTerms, IntByReference isSpectr);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int SpPropMse(long satKey, double mse, double[] xa_timeTypes, IntByReference revNum, double[] posJ2K, double[] velJ2K);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int SpPropDs50UTC(long satKey, double ds50UTC, double[] xa_timeTypes, IntByReference revNum, double[] posJ2K, double[] velJ2K);
   ...
   * @param covMtx             Resulting covariance matrix 6x6 (in 1D array) (out-Double[36])
   * @return 0 if successful, non-0 if there is an error
   */
   ...
   */
   public static native void SpGet4pAll(IntByReference geoIdx, IntByReference bulgePert, IntByReference dragPert, IntByReference radPresPert, IntByReference lunSolPert, IntByReference f10, IntByReference f10Avg, IntByReference ap, IntByReference trunc, IntByReference incr, IntByReference ogPert, IntByReference tidePert, IntByReference inCoord, IntByReference nTerms, IntByReference reEval, IntByReference integStepMode, IntByReference stepSizeMethod, DoubleByReference initStepSize, byte[] dcaFile, byte[] fluxFile, byte[] geoFile, byte[] jplFile, byte[] jplStart, byte[] jplStop);
   ...
   */
   public static native int SpGetEphemTimes(long satKey, int maxEphPts, double startDs50UTC, double stopDs50UTC, double minStepSize, IntByReference actualEphPts, double[] ds50UTCArr);
   ...
   */
   public static native int SpGenEphems(long satKey, double startDs50UTC, double stopDs50UTC, double stepSize, int sp_ephem, int arrSize, double[] ephemArr, IntByReference genEphemPts);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int SpGenEphemsCov(long satKey, double startDs50UTC, double stopDs50UTC, double stepSize, int sp_ephem, int covType, int arrSize, double[] ephemArr, IntByReference genEphemPts);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int SpGenEphemsVcm_OS(String vcmString, double startDs50UTC, double stopDs50UTC, double stepSize, int sp_ephem, int arrSize, double[] ephemArr, IntByReference genEphemPts);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int SpGenEphemsVcmCov_OS(String vcmString, double startDs50UTC, double stopDs50UTC, double stepSize, int sp_ephem, int covType, int arrSize, double[] ephemArr, IntByReference genEphemPts);
