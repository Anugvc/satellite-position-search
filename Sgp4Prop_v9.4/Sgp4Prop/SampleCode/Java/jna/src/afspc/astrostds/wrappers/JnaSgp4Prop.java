...
/** This class defines the JNA component of the wrapper for: Sgp4Prop */
public class JnaSgp4Prop
{
   ...
   */
   public static native int Sgp4PropMse(long satKey, double mse, DoubleByReference ds50UTC, double[] pos, double[] vel, double[] llh);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int Sgp4PropDs50UTC(long satKey, double ds50UTC, DoubleByReference mse, double[] pos, double[] vel, double[] llh);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int Sgp4GenEphems(long satKey, double startTime, double endTime, double stepSize, int sgp4_ephem, int arrSize, double[] ephemArr, IntByReference genEphemPts);
   ...
   * @return 0 if the propagation is successful, non-0 if there is an error (see error decoder in GP_ERR_?).
   */
   public static native int Sgp4GenEphems_OS(double[] xa_tle, double startTime, double endTime, double stepSize, int sgp4_ephem, int arrSize, double[] ephemArr, IntByReference genEphemPts);
