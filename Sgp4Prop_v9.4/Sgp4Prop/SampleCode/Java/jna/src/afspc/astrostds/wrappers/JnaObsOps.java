...
/** This class defines the JNA component of the wrapper for: ObsOps */
public class JnaObsOps
{
   ...
   */
   public static native void IomodGetIpAll(IntByReference printIOHG, IntByReference useFirst3Obs, IntByReference satNum, IntByReference sortOrder, byte[] satName, IntByReference runDC, IntByReference runRotas, double[] extArr);
   ...
   */
   public static native int ManyObsToPosVel(long[] obsKeyArr, int arrSize, DoubleByReference timeDs50UTC, double[] pos, double[] vel, long[] arr3ObsKeys);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int ThreeObsToPosVel(long[] arr3ObsKeys, DoubleByReference timeDs50UTC, double[] pos, double[] vel);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int Iomod_OS(double[] xa_senLoc, int numObs, double[] xa_obsArr, DoubleByReference timeDs50UTC, double[] pos, double[] vel);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int TwoObsToPosVel(long[] arr2ObsKeys, DoubleByReference timeDs50UTC, double[] pos, double[] vel);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int AnglesOnlyToPosVel(long[] arr3ObsKeys, double range1, double range3, int nhrev, int ind, int maxIt, double pdInc, double criVal, DoubleByReference timeDs50UTC, double[] pos, double[] vel);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int FindTrack(long[] obsKeyArr, int arrSize, int startIdx, IntByReference trackLength);
   ...
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int ATrackToPosVel(long[] obsKeys, int trackStartIdx, int trackLength, DoubleByReference timeDs50UTC, double[] pos, double[] vel, long[] trackObsKeys);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int TriCompute1(long[] obsKeyArr, int arrSize, double[] xa_tri, IntByReference numOvlps, double[] xa_ovlp, IntByReference numFits, double[] xa_fit, int maxGenObs, IntByReference nGenObs, long[] genObsKeys);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int TriCompute2(long[] obsKeyArr, int arrSize, double[] xa_tri, IntByReference numOvlps, double[] xa_ovlp, IntByReference numFits, double[] xa_fit);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int TriCompute3(long[] obsKeyArr, int arrSize, double[] xa_tri, int maxGenObs, IntByReference nGenObs, long[] genObsKeys);
   ...
   */
   public static native int AnglesOnlyToLLH(long obsKey, double assumedAltitude, double[] rho, double[] llhs, IntByReference numSols);
   ...
   */
   public static native void Lomb(double[] x, double[] y, int nSample, double ofac, double hifac, double[] px, double[] py, double[] prob, DoubleByReference pxmax, DoubleByReference pymax, DoubleByReference probMax);
   ...
   */
   public static native void AngleBetweenObs(long obsKey1, long obsKey2, DoubleByReference angSep, IntByReference errCode);
