...
/** This class defines the JNA component of the wrapper for: BatchDC */
public class JnaBatchDC
{
   ...
   */
   public static native int BatchDCInitSat(long satKey, IntByReference numObs, long[] obsKeys, int[] xai_dcElts, double[] xar_dcElts, byte[] xas_dcElts);
   ...
   * @return 0 if successful, non-0 if there is an error
   */
   public static native int BatchDCInitSatObsSel(long satKey, double[] xa_dcCtrl, double[] xa_selob, IntByReference numObs, long[] obsKeys, int[] xai_dcElts, double[] xar_dcElts, byte[] xas_dcElts);
