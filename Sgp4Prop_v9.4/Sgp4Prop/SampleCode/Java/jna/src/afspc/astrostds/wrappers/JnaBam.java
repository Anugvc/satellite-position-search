...
/** This class defines the JNA component of the wrapper for: Bam */
public class JnaBam
{
   ...
   */
   public static native void BamCompute(long[] satKeys, int numSats, double startDs50UTC, double stopDs50UTC, double stepSizeMin, double[] avgSDs, double[] avgMDs, double[] extBamArr, IntByReference errCode);
