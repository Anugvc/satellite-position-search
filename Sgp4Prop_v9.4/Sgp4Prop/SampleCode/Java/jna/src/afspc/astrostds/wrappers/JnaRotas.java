...
/** This class defines the JNA component of the wrapper for: Rotas */
public class JnaRotas
{
   ...
   */
   public static native void RotasGetPAll(byte[] rotasMode, DoubleByReference grossBeta, DoubleByReference betaLimit, DoubleByReference deltaTLimit, DoubleByReference deltaHLimit, IntByReference astat2Mult, IntByReference prtFlag, IntByReference retagFlag, IntByReference ltcFlag, IntByReference maxNumAssoc, IntByReference debiasFlag, IntByReference diagMode, IntByReference covPrtFlag, IntByReference isTrackMode, IntByReference remRetagObs, double[] extArr);
