...
/** This class defines the JNA component of the wrapper for: AstroFunc */
public class JnaAstroFunc
{
   ...
   * @param el                 Elevation (deg) (out-Double)
   */
   public static native void RaDecToAzElTime(double ds50UTC, double lat, double lon, double ra, double dec, DoubleByReference az, DoubleByReference el);
   ...
   */
   public static native void AzElToRaDec(double thetaG, double lat, double lon, double az, double el, DoubleByReference ra, DoubleByReference dec);
   ...
   * @param dec                Declination (deg) (out-Double)
   */
   public static native void AzElToRaDecTime(double ds50UTC, double lat, double lon, double az, double el, DoubleByReference ra, DoubleByReference dec);
   ...
   */
   public static native void RotRADecl(int nutationTerms, int dir, double ds50UTCIn, double raIn, double declIn, double ds50UTCOut, DoubleByReference raOut, DoubleByReference declOut);
   ...
   */
   public static native int RotRADec_DateToEqnx(int nutationTerms, int yrOfEqnx, double ds50UTCIn, double raIn, double declIn, DoubleByReference raOut, DoubleByReference declOut);
   ...
   * @return 0 if the rotation was successful, non-0 if there is an error
   */
   public static native int RotRADec_EqnxToDate(int nutationTerms, int yrOfEqnx, double ds50UTCIn, double raIn, double declIn, DoubleByReference raOut, DoubleByReference declOut);
   ...
   * @param covECI             6x6 (in 1D array) ECI Covariance (in-Double[36])
   * @param covEFG             6x6 (in 1D array) EFG Covariance (out-Double[36])
   */
   ...
   * ECI = Earth Centered Inertial - need to determine TEME or J2K
   * @param thetaG             theta - local sidereal time (rad) (in-Double)
   * @param covEFG             6x6 (in 1D array) EFG Covariance (in-Double[36])
   * @param covECI             6x6 (in 1D array) ECI Covariance (out-Double[36])
   */
   ...
   * @param symMtx6x6          Input 6x6 (in 1D array) symmetric matrix (in-Double[36])
   ...
   * @param symMtx6x6          Output 6x6 (in 1D array) symmetric matrix (out-Double[36])
   */
   ...
   * @param symMtx9x9          Input 9x9 (in 1D array) symmetric matrix (in-Double[81])
   ...
   * @param symMtx9x9          Output 9x9 (in 1D array) symmetric matrix (out-Double[81])
   */
   ...
   */
   public static native void AberrationAnnual(double ra, double decl, double dS50UTC, DoubleByReference raDelta, DoubleByReference decDelta);
   ...
   */
   public static native void AberrationDiurnal(double ra, double decl, double dS50UTC, double[] senPos, DoubleByReference raDelta, DoubleByReference decDelta);
   ...
   */
   public static native void JplGetParameters(byte[] jplFile, DoubleByReference ds50Start, DoubleByReference ds50Stop);
   ...
   * @param moonVecMag         The resulting magnitude of the moon position vector (km). (out-Double)
   */
   public static native void JplCompSunMoonVec(double ds50UTC, double[] uvecSun, DoubleByReference sunVecMag, double[] uvecMoon, DoubleByReference moonVecMag);
