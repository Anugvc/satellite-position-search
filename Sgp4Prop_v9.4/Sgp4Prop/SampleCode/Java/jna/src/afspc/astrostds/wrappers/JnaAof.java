...
/** This class defines the JNA component of the wrapper for: Aof */
public class JnaAof
{
   ...
   */
   public static native void AofGetDataFrInputFiles(double[] xa_aofCtrl, IntByReference numOfInpSats, int[] aofInpSats, IntByReference numOfMissions, double[] xa_aofSen, IntByReference numOfAreas, double[] xa_aofArea);
   ...
   */
   public static native int AofBasic(double[] xa_aofRun, long satKey, double[] xa_aofSen, double[] xa_aofArea, IntByReference numOfPasses, double[] xa_entExitTimes);
   ...
   * @return 0 if successfully, non-0 if there is an error
   */
   public static native int AofComplex(double[] xa_aofRun, long satKey, double[] xa_aofSen, int numOfLlhPts, double[] llhArr, IntByReference numOfPasses, double[] xa_entExitTimes);
