...
/** This class defines the JNA component of the wrapper for: ExtEphem */
public class JnaExtEphem
{
   ...
   */
   public static native int ExtEphGetAllFields(long satKey, IntByReference satNum, byte[] satName, byte[] recName, DoubleByReference epochDs50UTC, DoubleByReference ae, DoubleByReference ke, double[] pos, double[] vel, IntByReference coordSys, IntByReference numOfPts, byte[] fileLoc);
   ...
   */
   public static native int ExtEphStartEndTime(long satKey, DoubleByReference startDs50UTC, DoubleByReference endDs50UTC);
   ...
   */
   public static native int ExtEphGetEphemeris(long satKey, int index, DoubleByReference ds50UTC, double[] pos, double[] vel, IntByReference revNum);
   ...
   * @param vel                The resulting velocity (km/s) (out-Double[3])
   * @param revNum             The resulting revolution number (out-Integer)
   * @param covMtx             The 6x6 (in 1D array) covariance matrix (out-Double[36])
   * @return 0 if the ephemeris data is successfully retrieved, non-0 if there is an error
   */
   public static native int ExtEphGetCovMtx(long satKey, int index, DoubleByReference ds50UTC, double[] pos, double[] vel, IntByReference revNum, double[] covMtx);
   ...
   */
   public static native int ExtEphMse(long satKey, double mse, DoubleByReference ds50UTC, double[] pos, double[] vel, IntByReference revNum);
   ...
   * @return 0 if the external ephemeris data is successfully interpolated, non-0 if there is an error
   */
   public static native int ExtEphMseCovMtx(long satKey, double mse, DoubleByReference ds50UTC, double[] pos, double[] vel, IntByReference revNum, double[] covMtx);
   ...
   * @return 0 if the external ephemeris data is successfully interpolated, non-0 if there is an error
   */
   public static native int ExtEphDs50UTC(long satKey, double ds50UTC, DoubleByReference mse, double[] pos, double[] vel, IntByReference revNum);
   ...
   * @return 0 if the external ephemeris data is successfully interpolated, non-0 if there is an error
   */
   public static native int ExtEphDs50UTCCovMtx(long satKey, double ds50UTC, DoubleByReference mse, double[] pos, double[] vel, IntByReference revNum, double[] covMtx);
