...
/**
 * This test uses a single TLE initialized outside the propagation.  Each thread
 * uses the same TLE/satkey.
 */
public class PropagatorThreadTester1 implements Runnable {
    ...
    private long satKey = -1;
    private String hash;
    private boolean useFile = false;

    public PropagatorThreadTester1(String filename) {
...
//            }
    ...
    public static void main(String[] args) throws BrokenBarrierException, InterruptedException {
        ...
        List<PropagatorThreadTester1> testers = new ArrayList<>();
        for( int ii=0; ii<nThreads; ii++ ) {
            PropagatorThreadTester1 tester = new PropagatorThreadTester1("File-" + ii + ".txt");
            testers.add(tester);
