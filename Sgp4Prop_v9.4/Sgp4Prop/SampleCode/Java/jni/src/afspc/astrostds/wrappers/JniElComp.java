...
/** This class defines the JNI component of the wrapper for: ElComp */
public class JniElComp
{
   ...
   */
   public static native void LoadElCompDll();
   ...
   */
   public static native int ElCompGetResults(long priSatKey, long secSatKey, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, int[] elcom_astat);
   ...
   * @return 0 if ElComp is successful, non-0 if there is an error
   */
   public static native int ElCompGetResults_MT(double[] xa_ecdiff, long priSatKey, long secSatKey, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, int[] elcom_astat);
   ...
   */
   public static native void ElCompFrElData(int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, int[] elcom_astat);
   ...
   * @param elcom_astat        =1:FULL, =2:CLOSE, =3:MAYBE, =4:not assoc (out-Integer)
   */
   public static native void ElCompFrElData_MT(double[] xa_ecdiff, int checkDeltaTime, double[] xa_elcom_pri, double[] xa_elcom_sec, double[] xa_elcom_deltas, int[] elcom_astat);
   ...
   */
   public static native int CocoGetResults(long priSatKey, long secSatKey, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, int[] coco_astat);
   ...
   * @return 0 if Coco is successful, non-0 if there is an error
   */
   public static native int CocoGetResults_MT(double[] xa_ecdiff, long priSatKey, long secSatKey, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, int[] coco_astat);
   ...
   */
   public static native void CocoFrElData(double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, int[] coco_astat);
   ...
   * @param coco_astat         resulting astat value; 1=SAME, 2=CLOSE, 3=NEARBY, 5=NONE (out-Integer)
   */
   public static native void CocoFrElData_MT(double[] xa_ecdiff, double[] xa_satData_pri, double[] xa_satData_sec, double[] xa_coco, int[] coco_astat);
