...
/** This class defines the JNI component of the wrapper for: Combo */
public class JniCombo
{
   ...
   */
   public static native void LoadComboDll();
   ...
   */
   public static native void ComboGetNumOfPriSecSats(int[] numPriSats, int[] numSecSats);
   ...
   */
   public static native void ComboGet7pAll(int[] timeFlg, double[] startTime, double[] stopTime, int[] relMinFlg, int[] absMinFlg, int[] closeProxFlg, int[] relEphFlg, double[] pocSigma, double[] relMinLim, double[] closeProxLim, double[] relEphInterval, int[] prtOpt);
   ...
   */
   public static native int ComboCompPriSec(long priSatKey, long secSatKey, double[] absMinDs50UTC, double[] absMinDist, double[] relMinDs50UTCs, int[] numOfRelMins, double[] entryDs50UTCs, double[] exitDs50UTCs, int[] numOfEntryExits);
   ...
   * @return 0 if the COMBO data was computed successfully, non-0 if there is an error
   */
   public static native int ComboCompPriSec_MT(double[] xa_cb_parms, long priSatKey, long secSatKey, double[] absMinDs50UTC, double[] absMinDist, double[] relMinDs50UTCs, int[] numOfRelMins, double[] entryDs50UTCs, double[] exitDs50UTCs, int[] numOfEntryExits);
   ...
   * @param priSatCov          The primary satellite's 3x3 covariance matrix (in-Double[3, 3])
   ...
   * @param secSatCov          The secondary satellite's 3x3 covariance matrix (in-Double[3, 3])
