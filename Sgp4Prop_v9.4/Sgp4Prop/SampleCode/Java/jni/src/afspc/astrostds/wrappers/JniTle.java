...
/** This class defines the JNI component of the wrapper for: Tle */
public class JniTle
{
   ...
   */
   public static native void LoadTleDll();
   ...
   */
   public static native void TleAddSatFrLinesML(String line1, String line2, long[] satKey);
   ...
   * @param satKey             The satKey of the newly added TLE on success, a negative value on error. (out-Long)
   */
   public static native void TleAddSatFrCsvML(String csvLine, long[] satKey);
   ...
   * @param satKey             The satKey of the newly added TLE on success, a negative value on error. (out-Long)
   */
   public static native void TleAddSatFrFieldsGP2ML(int satNum, char secClass, String satName, int epochYr, double epochDays, double bstar, int ephType, int elsetNum, double incli, double node, double eccen, double omega, double mnAnomaly, double mnMotion, int revNum, double nDotO2, double n2DotO6, long[] satKey);
   ...
   * @param satKey             The satKey of the newly added TLE on success, a negative value on error. (out-Long)
   */
   public static native void TleAddSatFrFieldsSPML(int satNum, char secClass, String satName, int epochYr, double epochDays, double bTerm, double ogParm, double agom, int elsetNum, double incli, double node, double eccen, double omega, double mnAnomaly, double mnMotion, int revNum, long[] satKey);
   ...
   */
   public static native int TleGetAllFieldsGP(long satKey, int[] satNum, byte[] secClass, byte[] satName, int[] epochYr, double[] epochDays, double[] bstar, int[] ephType, int[] elsetNum, double[] incli, double[] node, double[] eccen, double[] omega, double[] mnAnomaly, double[] mnMotion, int[] revNum);
   ...
   * @return 0 if all values are retrieved successfully, non-0 if there is an error.
   */
   public static native int TleGetAllFieldsGP2(long satKey, int[] satNum, byte[] secClass, byte[] satName, int[] epochYr, double[] epochDays, double[] bstar, int[] ephType, int[] elsetNum, double[] incli, double[] node, double[] eccen, double[] omega, double[] mnAnomaly, double[] mnMotion, int[] revNum, double[] nDotO2, double[] n2DotO6);
   ...
   * @return 0 if all values are retrieved successfully, non-0 if there is an error.
   */
   public static native int TleGetAllFieldsSP(long satKey, int[] satNum, byte[] secClass, byte[] satName, int[] epochYr, double[] epochDays, double[] bTerm, double[] ogParm, double[] agom, int[] elsetNum, double[] incli, double[] node, double[] eccen, double[] omega, double[] mnAnomaly, double[] mnMotion, int[] revNum);
   ...
   */
   public static native int TleParseGP(String line1, String line2, int[] satNum, byte[] secClass, byte[] satName, int[] epochYr, double[] epochDays, double[] nDotO2, double[] n2DotO6, double[] bstar, int[] ephType, int[] elsetNum, double[] incli, double[] node, double[] eccen, double[] omega, double[] mnAnomaly, double[] mnMotion, int[] revNum);
   ...
   * @return 0 if the TLE is parsed successfully, non-0 if there is an error.
   */
   public static native int TleParseSP(String line1, String line2, int[] satNum, byte[] secClass, byte[] satName, int[] epochYr, double[] epochDays, double[] bTerm, double[] ogParm, double[] agom, int[] elsetNum, double[] incli, double[] node, double[] eccen, double[] omega, double[] mnAnomaly, double[] mnMotion, int[] revNum);
   ...
   */
   public static native void TleGetSatKeyML(int satNum, long[] satKey);
   ...
   */
   public static native void TleFieldsToSatKeyML(int satNum, int epochYr, double epochDays, int ephType, long[] satKey);
   ...
   * @param satKey             The satKey of the newly added TLE on success, a negative value on error. (out-Long)
   */
   public static native void TleAddSatFrArrayML(double[] xa_tle, String xs_tle, long[] satKey);
   ...
   */
   public static native void GetCheckSums(String line1, String line2, int[] chkSum1, int[] chkSum2, int[] errCode);
