...
/** This class defines the JNI component of the wrapper for: TimeFunc */
public class JniTimeFunc
{
   ...
   */
   public static native void LoadTimeFuncDll();
   ...
   */
   public static native void UTCToTConRec(double ds50UTC, double[] taiMinusUTC, double[] ut1MinusUTC, double[] ut1Rate, double[] polarX, double[] polarY);
   ...
   */
   public static native void UTCToYrDays(double ds50UTC, int[] year, double[] dayOfYear);
   ...
   */
   public static native void UTCToTimeComps1(double ds50UTC, int[] year, int[] dayOfYear, int[] hh, int[] mm, double[] sss);
   ...
   * @param sss                A reference to a variable in which to store the second. Partial seconds may be expressed if necessary. (out-Double)
   */
   public static native void UTCToTimeComps2(double ds50UTC, int[] year, int[] month, int[] dayOfMonth, int[] hh, int[] mm, double[] sss);
   ...
   */
   public static native void Get6P(int[] startFrEpoch, int[] stopFrEpoch, double[] startTime, double[] stopTime, double[] interval);
   ...
   */
   public static native void TConTimeSpan(int[] numOfRecs, double[] frTimeDs50UTC, double[] toTimeDs50UTC);
