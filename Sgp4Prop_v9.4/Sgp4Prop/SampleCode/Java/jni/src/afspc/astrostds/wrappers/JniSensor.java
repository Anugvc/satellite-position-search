...
/** This class defines the JNI component of the wrapper for: Sensor */
public class JniSensor
{
   ...
   */
   public static native void LoadSensorDll();
   ...
   */
   public static native int SensorGetLocAll(long senKey, double[] astroLat, double[] astroLon, double[] senPos, byte[] senDesc, int[] orbSatNum, byte[] secClass);
   ...
   */
   public static native int SensorGet1L(long senKey, byte[] viewType, byte[] obsType, int[] rngUnits, double[] maxRngLim, byte[] boresight1, double[] elLim1, double[] elLim2, double[] azLim1, double[] azLim2, double[] interval, int[] visFlg, int[] rngLimFlg, int[] maxPPP, double[] minRngLim, int[] plntryRes, double[] rrLim);
   ...
   */
   public static native int SensorGet2L(long senKey, byte[] boresight2, double[] elLim3, double[] elLim4, double[] azLim3, double[] azLim4, int[] earthBckgrnd, double[] earthLimb, double[] solarXAngle, double[] lunarXAngle, double[] minIllum, double[] twilit);
   ...
   * @return 0 on success, non-0 if there is an error
   */
   public static native int SensorGetOrbSatKey(long senKey, long[] orbSatKey);
   ...
   */
   public static native int SensorGetSegment(long senKey, int segNum, int[] segType, double[] xa_seg);
   ...
   */
   public static native void SensorGetSenKeyML(int senNum, long[] senKey);
