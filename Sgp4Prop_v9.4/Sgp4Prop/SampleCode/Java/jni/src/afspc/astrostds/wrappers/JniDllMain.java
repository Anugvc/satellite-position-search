...
/** This class defines the JNI component of the wrapper for: DllMain */
public class JniDllMain
{
   ...
   */
   public static native void LoadDllMainDll();
   ...
   */
   public static native void TestInterface(char cIn, byte[] cOut, int intIn, int[] intOut, long longIn, long[] longOut, double realIn, double[] realOut, String strIn, byte[] strOut, int[] int1DIn, int[] int1DOut, long[] long1DIn, long[] long1DOut, double[] real1DIn, double[] real1DOut, int[][] int2DIn, int[][] int2DOut, long[][] long2DIn, long[][] long2DOut, double[][] real2DIn, double[][] real2DOut);
   ...
   * @param realIn             an input 64-bit real (in-Double)
   * @param realOut            an output 64-bit real - should return the same value as the input realIn (out-Double)
   * @param strIn              input string (in-Character[])
   * @param strOut             output string - should return the same value as the input strIn (out-Character[])
   * @param int1DIn            an input array of 32-bit integers (in-Integer[])
   * @param int1DOut           an output array of 32-bit integers - should return the same values as the input int1DIn (out-Integer[])
   * @param long1DIn           an input array of 64-bit integers (in-Long[])
   * @param long1DOut          an output array of 64-bit integers - should return the same values as the input long1DIn (out-Long[])
   * @param real1DIn           an input array of 64-bit reals (in-Double[])
   * @param real1DOut          an output array of 64-bit reals - should return the same values as the input real1DIn (out-Double[])
   * @param int2DIn            an input 2D-array of 32-bit integers (2 rows, 3 columns) - for column-major order language, reverse the order (in-Integer[])
   * @param int2DOut           an output 2D-array of 32-bit integers - should return the same values as the input int2DIn (out-Integer[])
   * @param long2DIn           an input 2D-array of 64-bit integers (2 rows, 3 columns) - for column-major order language, reverse the order (in-Long[])
   * @param long2DOut          an output 2D-array of 64-bit integers - should return the same values as the input long2DIn (out-Long[])
   * @param real2DIn           an input 2D-array of 64-bit reals (2 rows, 3 columns) - for column-major order language, reverse the order (in-Double[])
   * @param real2DOut          an output 2D-array of 64-bit reals - should return the same values as the input real2DIn (out-Double[])
   */
   public static native void TestInterface2Das1D(char cIn, byte[] cOut, int intIn, int[] intOut, long longIn, long[] longOut, double realIn, double[] realOut, String strIn, byte[] strOut, int[] int1DIn, int[] int1DOut, long[] long1DIn, long[] long1DOut, double[] real1DIn, double[] real1DOut, int[][] int2DIn, int[][] int2DOut, long[][] long2DIn, long[][] long2DOut, double[][] real2DIn, double[] real2DOut);
   ...
   */
   public static native void TestInterface2(byte[] cInOut, int[] intInOut, long[] longInOut, double[] realInOut, byte[] strInOut, int[] int1DInOut, long[] long1DInOut, double[] real1DInOut, int[][] int2DInOut, long[][] long2DInOut, double[][] real2DInOut);
   ...
   * @param longInOut          Output should return Input + 2 (inout-Long)
   * @param realInOut          Output should return Input + 42.123456 (inout-Double)
   * @param strInOut           Output should return "It doesn't matter what your string was." (inout-Character[])
   * @param int1DInOut         Output should return Input + 1 (inout-Integer[])
   * @param long1DInOut        Output should return Input + 1234567890123456789 (inout-Long[])
   * @param real1DInOut        Output should return Input + 42.0 (inout-Double[])
   * @param int2DInOut         Output should return Input + 1 (inout-Integer[])
   * @param long2DInOut        Output should return Input + 6 (inout-Long[])
   * @param real2DInOut        Output should return Input + 7.6 (inout-Double[])
   */
   public static native void TestInterface22Das1D(byte[] cInOut, int[] intInOut, long[] longInOut, double[] realInOut, byte[] strInOut, int[] int1DInOut, long[] long1DInOut, double[] real1DInOut, int[][] int2DInOut, long[][] long2DInOut, double[] real2DInOut);
