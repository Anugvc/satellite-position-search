...
/** This class defines the JNI component of the wrapper for: ElOps */
public class JniElOps
{
   ...
   */
   public static native void LoadElOpsDll();
   ...
   */
   public static native int FindSatDecayTime(long satKey, double f10Avg, double[] decayDs50UTC);
