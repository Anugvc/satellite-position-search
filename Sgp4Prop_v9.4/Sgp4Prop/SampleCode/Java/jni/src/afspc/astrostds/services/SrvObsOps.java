...
public class SrvObsOps
{
    ...
    public static class IomodControl
    {
        ...
        public IomodControl() {
            ...
            int[] printIOHG = new int [1];
            int[] useFirst3Obs = new int [1];
            int[] satNum = new int [1];
            int[] sortOrder = new int [1];
            int[] runDC = new int [1];
            int[] runRotas = new int [1];
            byte[] satName = new byte[9];
            JniObsOps.IomodGetIpAll(printIOHG, useFirst3Obs, satNum, sortOrder, satName, runDC, runRotas, extArr);
            this.printIOHG = printIOHG[0] == 1;
            this.useFirst3Obs = useFirst3Obs[0] == 1;
            this.satNum = satNum[0];
            this.sortOrder = sortOrder[0];
            this.satName = Utility.BytesToString(satName);
            this.runDC = runDC[0];
            this.runRotas = runRotas[0];
        }
