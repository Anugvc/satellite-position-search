...
/** This class defines the JNI component of the wrapper for: Lamod */
public class JniLamod
{
   ...
   */
   public static native void LoadLamodDll();
   ...
   */
   public static native void LamodGetNumOfSensSats(int[] numSens, int[] numSats);
   ...
   */
   public static native void LamodGet1pAll(int[] timeFlg, double[] startTime, double[] stopTime, double[] interval, int[] prtOpt, int[] punchObs, int[] visFlg, int[] stepMode, byte[] schedMode, int[] diagMode, double[] solAspAngle);
   ...
   */
   public static native void LamodGet3pAll(int[] concurrFlg, int[] concurrSens);
   ...
   */
   public static native int LamodGetSenSatDataAll(long senSatKey, int[] stepMode, int[] optVisFlg, double[] startDs50TAI, double[] stopDs50TAI, double[] interval, double[] period);
   ...
   * Note: For Fence/Fan typed sensors this function returns enter/penetration-cross/exit times in place of rise/culmination/set times
   * @param senSatKey          sensor/satellite pair's unique key (in-Long)
   * @param rcsTimeArr         array of rise/culmination/set times in days since 1950 TAI of the possible passes (out-Double[])
   * @return 0 if the computation is successful, non-0 if there is an error
   */
   public static native int LamodGetRiseCulmSetTimes2Das1D(long senSatKey, double[] rcsTimeArr);
   ...
   */
   public static native int LamodComputeLookAngle(long senSatKey, double currDs50TAI, int[] lookCode, double[] xa_look, double[] senElts, double[] satElts);
   ...
   */
   public static native int LamodGetOrbSenViewdata(long senSatKey, double[] uvSun, double[] uvMoon, double[] xa_angle, int[] nBore1, int[] nBore2, double[] xa_offBore);
   ...
   */
   public static native void LamodCompRaDec(double[] xlPos, double[] rasc, double[] decl, int[] raHr, int[] raMin, double[] raSec, int[] decDeg, int[] decMin, double[] decSec);
   ...
   */
   public static native int LamodGenObs(long senSatKey, int punchObs, char obsClass, byte[] obsLine1, byte[] obsLine2, int[] numLines);
   ...
   * @return 0 if the generated obs strings are retrieved successfully, non-0 if there is an error
   */
   public static native int LamodGenObsAtTime(long senSatKey, double currDs50TAI, int punchObs, char obsClass, byte[] obsLine1, byte[] obsLine2, int[] numLines);
