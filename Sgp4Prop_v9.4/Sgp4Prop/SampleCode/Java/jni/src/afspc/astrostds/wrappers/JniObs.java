...
/** This class defines the JNI component of the wrapper for: Obs */
public class JniObs
{
   ...
   */
   public static native void LoadObsDll();
   ...
   */
   public static native void ObsAddFrB3CardML(String card, long[] obsKey);
   ...
   * @param obsKey             The obsKey of the newly added observation on success, a negative value on error (out-Long)
   */
   public static native void ObsAddFrTTYCardsML(String card1, String card2, long[] obsKey);
   ...
   * @param obsKey             The obsKey of the newly added observation on success, a negative value on error (out-Long)
   */
   public static native void ObsAddFrCsvML(String csvLine, long[] obsKey);
   ...
   * @param obsKey             The obsKey of the newly added observation on success, a negative value on error (out-Long)
   */
   public static native void ObsAddFrArrayML(double[] xa_obs, long[] obsKey);
   ...
   */
   public static native int ObsGetAllFields(long obsKey, byte[] secClass, int[] satNum, int[] senNum, double[] obsTimeDs50utc, double[] elOrDec, double[] azOrRA, double[] range, double[] rangeRate, double[] elRate, double[] azRate, double[] rangeAccel, byte[] obsType, int[] trackInd, int[] astat, int[] siteTag, int[] spadocTag, double[] pos, double[] vel, double[] extArr);
   ...
   */
   public static native void ObsFieldsToObsKeyML(int satNum, int senNum, double obsTimeDs50utc, long[] obsKey);
   ...
   */
   public static native int ObsB3Parse(String b3ObsCard, byte[] secClass, int[] satNum, int[] senNum, double[] obsTimeDs50utc, double[] elOrDec, double[] azOrRA, double[] range, double[] rangeRate, double[] elRate, double[] azRate, double[] rangeAccel, byte[] obsType, int[] trackInd, int[] astat, int[] siteTag, int[] spadocTag, double[] pos);
   ...
   */
   public static native void ObsGetSelected(double[] xa_selob, int order, int[] numMatchedObss, long[] obsKeys);
