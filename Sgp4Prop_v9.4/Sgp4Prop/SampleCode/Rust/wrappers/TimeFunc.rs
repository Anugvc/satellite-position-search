...
extern "C" {
   ...
   pub fn TConAddARec(refDs50UTC: f64, leapDs50UTC: f64, taiMinusUTC: f64, ut1MinusUTC: f64, ut1Rate: f64, polarX: f64, polarY: f64) -> i32;
   //  Adds one timing constant record to memory. This API can be used to avoid TConLoadFile's file I/O
   pub fn TConAddOne(refDs50UTC: f64, taiMinusUTC: f64, ut1MinusUTC: f64, ut1Rate: f64, polarX: f64, polarY: f64) -> i32;
   ...
   pub fn UTCToTConRec(ds50UTC: f64, taiMinusUTC: *mut f64, ut1MinusUTC: *mut f64, ut1Rate: *mut f64, polarX: *mut f64, polarY: *mut f64);
   ...
   pub fn UTCToTimeComps1(ds50UTC: f64, year: *mut i32, dayOfYear: *mut i32, hh: *mut i32, mm: *mut i32, sss: *mut f64);
   ...
   //  See "TimeComps1ToUTC" for an example.
   //  The input ds50UTC must be greater than 2192.0, which corresponds to a time later than 1st Jan 1956. Any input value less than or equal to 2192.0 will be reset to that value.
   pub fn UTCToTimeComps2(ds50UTC: f64, year: *mut i32, month: *mut i32, dayOfMonth: *mut i32, hh: *mut i32, mm: *mut i32, sss: *mut f64);
   ...
   pub fn Get6P(startFrEpoch: *mut i32, stopFrEpoch: *mut i32, startTime: *mut f64, stopTime: *mut f64, interval: *mut f64);
