...
extern "C" {
   ...
   pub fn GetInitDllNames(initDllNames: *const c_char);
   //  Tests different input/output data types that are supported by the Astrodynamic Standards library.
   pub fn TestInterface(cIn: c_char, cOut: *const c_char, intIn: i32, intOut: *mut i32, longIn: i64, longOut: *mut i64, realIn: f64, realOut: *mut f64, strIn: *const c_char, strOut: *const c_char, int1DIn: *const [i32; 3], int1DOut: *mut [i32; 3], long1DIn: *const [i64; 3], long1DOut: *mut [i64; 3], real1DIn: *const [f64; 3], real1DOut: *mut [f64; 3], int2DIn: *const [[i32; 3]; 2], int2DOut: *mut [[i32; 3]; 2], long2DIn: *const [[i64; 3]; 2], long2DOut: *mut [[i64; 3]; 2], real2DIn: *const [[f64; 3]; 2], real2DOut: *mut [[f64; 3]; 2]);
   //  Tests different input/output data types that are supported by the Astrodynamic Standards library.
   pub fn TestInterface2(cInOut: *const c_char, intInOut: *mut i32, longInOut: *mut i64, realInOut: *mut f64, strInOut: *const c_char, int1DInOut: *mut [i32; 3], long1DInOut: *mut [i64; 3], real1DInOut: *mut [f64; 3], int2DInOut: *mut [[i32; 3]; 2], long2DInOut: *mut [[i64; 3]; 2], real2DInOut: *mut [[f64; 3]; 2]);
   ...
   pub static GETSETSTRLEN: i32 = 512;
   ...
   pub static ELTTYPE_TLE_SGP: i32 = 1;
   // Element type - SGP4 Tle type 2
   pub static ELTTYPE_TLE_SGP4: i32 = 2;
   // Element type - SP Tle type 6
   pub static ELTTYPE_TLE_SP: i32 = 3;
   // Element type - SP Vector
   pub static ELTTYPE_SPVEC_B1P: i32 = 4;
   // Element type - VCM
   pub static ELTTYPE_VCM: i32 = 5;
   // Element type - External ephemeris
   pub static ELTTYPE_EXTEPH: i32 = 6;
   // Element type - SGP Tle type 4 - XP
   pub static ELTTYPE_TLE_XP: i32 = 7;
