...
extern "C" {
   ...
   pub fn SatStateGetSatDataAll(satKey: i64, satNum: *mut i32, satName: *const c_char, eltType: *mut i32, revNum: *mut i32, epochDs50UTC: *mut f64, bField: *mut f64, elsetNum: *mut i32, incli: *mut f64, node: *mut f64, eccen: *mut f64, omega: *mut f64, mnAnomaly: *mut f64, mnMotion: *mut f64, period: *mut f64, perigeeHt: *mut f64, apogeeHt: *mut f64, perigee: *mut f64, apogee: *mut f64, a: *mut f64) -> i32;
   ...
   pub fn SatStateMse(satKey: i64, mse: f64, ds50UTC: *mut f64, revNum: *mut i32, pos: *mut [f64; 3], vel: *mut [f64; 3], llh: *mut [f64; 3]) -> i32;
   //  Propagates a TLE/SPVEC/VCM, or interpolates an EXTEPHEM. 
   //  The satellite is propagated/interpolated to the specified time calculated in days since 1950, UTC.
   pub fn SatStateDs50UTC(satKey: i64, ds50UTC: f64, mse: *mut f64, revNum: *mut i32, pos: *mut [f64; 3], vel: *mut [f64; 3], llh: *mut [f64; 3]) -> i32;
   ...
   pub fn SatStateEphCom(primSatKey: i64, secSatKey: i64, ds50UTC: f64, uvwFlag: i32, xa_Delta: *mut [f64; 100]) -> i32;
   //  Returns various ephemeris comparison results between two satellite states (_OS one step) .
   //  <br>
   //  The "in-track" is NOT the velocity direction, but is defined as completing the right handed coordinate system 
   //  defined by the position vector (radial) and the angular momentum vector (cross-track).
   pub fn SatStateEphCom_OS(priPosVel: *const [f64; 6], secPosVel: *const [f64; 6], ds50UTC: f64, uvwFlag: i32, xa_Delta: *mut [f64; 100]);
   ...
   pub fn SatStateGenEphFile(satKey: i64, startDs50UTC: f64, stopDs50UTC: f64, stepSizeSecs: f64, ephFileName: *const c_char, ephFileType: i32) -> i32;
   ...
   pub fn GobsCom(primSatKey: i64, secSatKey: i64, ds50UTC: f64, xa_gobs_lim: *const [f64; 16], xa_gobs_delta: *mut [f64; 16]) -> i32;
   //  Does an XP GOBS comparison using gobs arrays
   pub fn GobsComArr(xa_gobs_prim: *const [f64; 32], xa_gobs_sec: *const [f64; 32], xa_gobs_lim: *const [f64; 16], xa_gobs_delta: *mut [f64; 16]);
}
   ...
   // delta position (km)
   pub static XA_DELTA_POS: i32 =  0;
   // delta time (sec)
   pub static XA_DELTA_TIME: i32 =  1;
   // delta position in radial direction (km)
   pub static XA_DELTA_PRADIAL: i32 =  2;
   // delta position in in-track direction (km)
   pub static XA_DELTA_PINTRCK: i32 =  3;
   // delta position in cross-track direction (km)
   pub static XA_DELTA_PCRSSTRCK: i32 =  4;
   // delta velocity (km/sec)
   pub static XA_DELTA_VEL: i32 =  5;
   // delta velocity in radial direction (km/sec)
   pub static XA_DELTA_VRADIAL: i32 =  6;
   // delta velocity in in-track direction (km/sec)
   pub static XA_DELTA_VINTRCK: i32 =  7;
   // delta velocity in cross-track direction (km/sec)
   pub static XA_DELTA_VCRSSTRCK: i32 =  8;
   // delta Beta (deg)
   pub static XA_DELTA_BETA: i32 =  9;
   // delta height (km)
   pub static XA_DELTA_HEIGHT: i32 = 10;
   // delta angular momentum (deg)
   pub static XA_DELTA_ANGMOM: i32 = 11;
   ...
   pub static XA_DELTA_SIZE: i32 =100;
   ...
   // af
   pub static XA_GOBS_AF: i32 =  7;
   // ag
   pub static XA_GOBS_AG: i32 =  8;
   // AGOM
   pub static XA_GOBS_AGOM: i32 =  9;
   // Trough/Drift Flag, 0 - 75 deg trough, 1 - 255 deg trough, 2 - both troughs, 3 - unstable point, 4 - East drift, 5 - West drift
   pub static XA_GOBS_TROUGH: i32 = 10;
   ...
   // delta shape
   pub static XA_GOBS_DELTA_DSHAPE: i32 =  4;
