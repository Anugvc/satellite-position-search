...
extern "C" {
   ...
   //  </ul>
   pub fn Sgp4PropMse(satKey: i64, mse: f64, ds50UTC: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], llh: *mut [f64; 3]) -> i32;
   ...
   //  </ul>
   pub fn Sgp4PropDs50UTC(satKey: i64, ds50UTC: f64, mse: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], llh: *mut [f64; 3]) -> i32;
   //  Propagates a satellite, represented by the satKey, to the time expressed in days since 1950, UTC. 
   ...
   pub fn Sgp4PosVelToKep(yr: i32, day: f64, pos: *const [f64; 3], vel: *const [f64; 3], posNew: *mut [f64; 3], velNew: *mut [f64; 3], xa_kep: *mut [f64; 6]) -> i32;
   ...
   pub fn Sgp4GenEphems(satKey: i64, startTime: f64, endTime: f64, stepSize: f64, sgp4_ephem: i32, arrSize: i32, ephemArr: *mut f64, genEphemPts: *mut i32) -> i32;
   ...
   //    that many points (arrSize) and the errCode is set to IDX_ERR_WARN
   pub fn Sgp4GenEphems_OS(xa_tle: *const [f64; 64], startTime: f64, endTime: f64, stepSize: f64, sgp4_ephem: i32, arrSize: i32, ephemArr: *mut f64, genEphemPts: *mut i32) -> i32;
   ...
   pub fn XpReepochGetNativeElts(satKey: i64, reEpochDs50UTC: f64, csvLine: *const c_char, xa_eqnx: *mut [f64; 6], xa_eqnx_dot: *mut [f64; 6]) -> i32;
}
   ...
   pub static XA_SGP4OUT_DS50UTC: i32 =  0;
   // Propagation time in minutes since the satellite's epoch time
   pub static XA_SGP4OUT_MSE: i32 =  1;
   // ECI X position (km) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_POSX: i32 =  2;
   // ECI Y position (km) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_POSY: i32 =  3;
   // ECI Z position (km) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_POSZ: i32 =  4;
   // ECI X velocity (km/s) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_VELX: i32 =  5;
   // ECI Y velocity (km/s) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_VELY: i32 =  6;
   // ECI Z velocity (km/s) in True Equator and Mean Equinox of Epoch
   pub static XA_SGP4OUT_VELZ: i32 =  7;
   // Geodetic latitude (deg)
   pub static XA_SGP4OUT_LAT: i32 =  8;
   // Geodetic longitude (deg)
   pub static XA_SGP4OUT_LON: i32 =  9;
   // Height above geoid (km)
   pub static XA_SGP4OUT_HEIGHT: i32 = 10;
   // Revolution number
   pub static XA_SGP4OUT_REVNUM: i32 = 11;
   // Nodal period (min)
   pub static XA_SGP4OUT_NODALPER: i32 = 12;
   // Apogee (km)
   pub static XA_SGP4OUT_APOGEE: i32 = 13;
   // Perigee (km)
   pub static XA_SGP4OUT_PERIGEE: i32 = 14;
   // Mean semi-major axis (km)
   pub static XA_SGP4OUT_MN_A: i32 = 15;
   // Mean eccentricity (unitless)
   pub static XA_SGP4OUT_MN_E: i32 = 16;
   // Mean inclination (deg)
   pub static XA_SGP4OUT_MN_INCLI: i32 = 17;
   // Mean mean anomaly (deg)
   pub static XA_SGP4OUT_MN_MA: i32 = 18;
   // Mean right ascension of the asending node (deg)
   pub static XA_SGP4OUT_MN_NODE: i32 = 19;
   // Mean argument of perigee (deg)
   pub static XA_SGP4OUT_MN_OMEGA: i32 = 20;
   // Osculating semi-major axis (km)
   pub static XA_SGP4OUT_OSC_A: i32 = 21;
   // Osculating eccentricity (unitless)
   pub static XA_SGP4OUT_OSC_E: i32 = 22;
   // Osculating inclination (deg)
   pub static XA_SGP4OUT_OSC_INCLI: i32 = 23;
   // Osculating mean anomaly (deg)
   pub static XA_SGP4OUT_OSC_MA: i32 = 24;
   // Osculating right ascension of the asending node (deg)
   pub static XA_SGP4OUT_OSC_NODE: i32 = 25;
   // Osculating argument of perigee (deg)
   pub static XA_SGP4OUT_OSC_OMEGA: i32 = 26;
   
   pub static XA_SGP4OUT_SIZE: i32 = 64;
