...
extern "C" {
   ...
   pub fn ExtEphAddSatEphem(satKey: i64, ds50UTC: f64, pos: *const [f64; 3], vel: *const [f64; 3], revNum: i32) -> i32;
   //  Adds an ephemeris point (including covariance matrix) to the end of an EXTEPHEM's set of ephemeris points
   pub fn ExtEphAddSatEphemCovMtx(satKey: i64, ds50UTC: f64, pos: *const [f64; 3], vel: *const [f64; 3], revNum: i32, covUVW: *const [f64; 21]) -> i32;
   //  Adds an ephemeris point (including covariance matrix) to the end of an EXTEPHEM's set of ephemeris points
   pub fn ExtEphAddSatEphemExt(satKey: i64, ds50UTC: f64, pos: *const [f64; 3], vel: *const [f64; 3], revNum: i32, extArr: *const [f64; 128]) -> i32;
   ...
   pub fn ExtEphGetAllFields(satKey: i64, satNum: *mut i32, satName: *const c_char, recName: *const c_char, epochDs50UTC: *mut f64, ae: *mut f64, ke: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], coordSys: *mut i32, numOfPts: *mut i32, fileLoc: *const c_char) -> i32;
   ...
   pub fn ExtEphGetEphemeris(satKey: i64, index: i32, ds50UTC: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32) -> i32;
   //  Retrieves the data (including the covariance matrix) for a specific point within an EXTEPHEM
   pub fn ExtEphGetCovMtx(satKey: i64, index: i32, ds50UTC: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32, covMtx: *mut [[f64; 6]; 6]) -> i32;
   ...
   pub fn ExtEphMse(satKey: i64, mse: f64, ds50UTC: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32) -> i32;
   //  Interpolates the external ephemeris data to the requested time in minutes since the satellite's epoch time
   pub fn ExtEphMseCovMtx(satKey: i64, mse: f64, ds50UTC: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32, covMtx: *mut [[f64; 6]; 6]) -> i32;
   //  Interpolates the external ephemeris data to the requested time in days since 1950, UTC
   //  The coordinate system of the output position and velocity is the same as the input ephemerides.
   pub fn ExtEphDs50UTC(satKey: i64, ds50UTC: f64, mse: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32) -> i32;
   //  Interpolates the external ephemeris data to the requested time in days since 1950, UTC
   pub fn ExtEphDs50UTCCovMtx(satKey: i64, ds50UTC: f64, mse: *mut f64, pos: *mut [f64; 3], vel: *mut [f64; 3], revNum: *mut i32, covMtx: *mut [[f64; 6]; 6]) -> i32;
